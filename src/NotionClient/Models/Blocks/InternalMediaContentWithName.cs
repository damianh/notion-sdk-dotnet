...
/// <summary>Media block content backed by an internal Notion file, with a file name.</summary>
public sealed class InternalMediaContentWithName
{
    ...
    /// <summary>Gets the optional display name of the file shown to users in the Notion UI.</summary>
